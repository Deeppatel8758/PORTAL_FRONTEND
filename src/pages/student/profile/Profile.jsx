...
export default function Profile() {
  ...
  const getStudentData = async () => {
    try {
      ...
      let studentCollegeDetails = response.data.data.studentData.studentCollegeDetails;
      let studentPersonalDetails = response.data.data.studentData.studentPersonalDetails;
      const profile=response.data.data.filesData[0]
      const signatureUrl=response.data.data.filesData[1]

    //change 

    const isVerified =studentCollegeDetails.verifiedDepartment;
