  ...
  const getStudentData = async () => {
    ...
    try {
      ...
      if (response.data.data.filesData.length > 0) {
        const profile = response.data.data.filesData[0].data.data;
        const signatureUrl = response.data.data.filesData[1].data.data;
        ...
        const base64DataProfile = uint8ArrayToBase64(uint8ArrayProfile);
        const ProfiledataUrl = `data:image/jpeg;base64,${base64DataProfile}`;
      
        const uint8ArraySignature = new Uint8Array(signatureUrl);
        const base64DataSignature = uint8ArrayToBase64(uint8ArraySignature);
